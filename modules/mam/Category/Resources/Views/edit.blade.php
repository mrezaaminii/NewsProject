                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                   value="{{ old('name',$user->name) }}" id="name" name="name" placeholder="نام کاربر را وارد کنید">
                                            @error('name')
                                            <br>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" class="form-control @error('email') is-invalid @enderror"
                                                   value="{{ old('email',$user->email) }}" id="email" name="email" placeholder="ایمیل کاربر را وارد کنید">
                                            @error('email')
                                            <br>
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
