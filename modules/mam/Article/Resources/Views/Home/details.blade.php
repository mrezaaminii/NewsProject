    ...
    <main class="position-relative">
        <div class="container">
            <div class="entry-header entry-header-1 mb-30 mt-50">
                <div class="entry-meta meta-0 font-small mb-30"><a href="{{ route('category.details',$article->category->slug) }}"><span
                            class="post-cat bg-success color-white">{{ $article->category->title }}</span></a></div>
                ...
                <div class="entry-meta meta-1 font-x-small color-grey text-uppercase">
                    ...
                    <span
                        class="post-on">ارسال در {{ Helper::convertEnglishToPersian(jdate($article->created_at)) }}</span>
                    <span class="time-reading">زمان خواندن {{ $article->time_to_read }} دقیقه</span>
                    <p class="font-x-small mt-10">
                        <span class="hit-count"><i
                                class="ti-comment ml-5"></i>نظرات {{ $article->comments->count() }}</span>
                        <span class="hit-count"><i
                                class="ti-heart ml-5"></i>لایک {{ $article->likers()->count() }}</span>
                    ...
                    <div class="author-bio border-radius-10 bg-white p-30 mb-40">
                        ...
                        <div class="author-info">
                            <h3><span class="vcard author"><span class="fn"><a href="author.html"
                                                                               title="Posts by Robert" rel="author">سعید شمس</a></span></span>
                            </h3>
                            <h5 class="text-muted">
