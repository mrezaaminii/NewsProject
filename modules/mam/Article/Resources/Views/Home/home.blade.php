                                                ...
                                                <div class="post-thumb d-flex mb-15 border-radius-15 img-hover-scale">
                                                    <a href="{{ $article->getPath() }}">
                                                        <img class="border-radius-15 article-img-style"
                                                             src="{{ asset('storage' . DIRECTORY_SEPARATOR.$article->imagePath) }}"
                                                             alt="{{ $article->title }}">
                                                    </a>
                                                </div>
                            ...
                            <div class="sidebar-widget mb-50">
                                ...
                                <div class="post-aside-style-2">
                                    <ul class="list-post">
                                        ...
                                        <li class="mb-30 wow fadeIn
                                         animated" style="visibility: visible; animation-name: fadeIn;">
                                            <div class="d-flex">
                                                <div class="post-thumb d-flex ml-15 border-radius-5 img-hover-scale">
                                                    <a class="color-white" href="{{ $article->getPath() }}">
                                                        <img src="{{ asset('storage' . DIRECTORY_SEPARATOR.$article->imagePath) }}"
                                                             alt="{{ $article->title }}">
                                                    </a>
                                                </div>
                                                <div class="post-content media-body">
                                                    ...
                                                    <div class="entry-meta meta-1 font-x-small
                                                     color-grey float-right text-uppercase">
                                                        <span class="post-by">توسط
                                                            <a href="{{ $article->user?->getPath() }}">
                                                                {{ $article->user?->name }}
                                                            </a>
                                                        </span>
                                                        <span class="post-on">
